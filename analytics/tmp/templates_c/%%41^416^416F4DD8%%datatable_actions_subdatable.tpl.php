<?php /* Smarty version 2.6.26, created on 2013-10-09 08:16:05
         compiled from CoreHome/templates/datatable_actions_subdatable.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'translate', 'CoreHome/templates/datatable_actions_subdatable.tpl', 7, false),)), $this); ?>
...
<?php else: ?>
    <?php if (count ( $this->_tpl_vars['arrayDataTable'] ) == 0): ?>
        <tr>
            <td colspan="<?php echo $this->_tpl_vars['nbColumns']; ?>
