<?php /* Smarty version 2.6.26, created on 2013-10-09 07:28:57
         compiled from CorePluginsAdmin/templates/manage.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'translate', 'CorePluginsAdmin/templates/manage.tpl', 5, false),array('modifier', 'nl2br', 'CorePluginsAdmin/templates/manage.tpl', 32, false),)), $this); ?>
...
<?php if (isset ( $this->_tpl_vars['plugin']['info']['author_homepage'] )): ?></a><?php endif; ?>
                                    .</cite>
                            <?php endif; ?>
                        </td>
                        <td class="status">
...
<?php endif; ?>
                        ...
                        <td class="togl action-links">
                            <?php if ($this->_tpl_vars['plugin']['activated']): ?><a
                                href='index.php?module=CorePluginsAdmin&action=deactivate&pluginName=<?php echo $this->_tpl_vars['name']; ?>
...
'><?php echo ((is_array($_tmp='CorePluginsAdmin_Deactivate')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
                            ...
                            <?php else: ?><a
                                href='index.php?module=CorePluginsAdmin&action=activate&pluginName=<?php echo $this->_tpl_vars['name']; ?>
&token_auth=<?php echo $this->_tpl_vars['token_auth']; ?>
